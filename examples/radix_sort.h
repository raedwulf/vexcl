const char *radix_sort_source = R"###(
/*
...
*/
// Author: Takahiro Harada (Original Bullet)
// Author: Tai Chi Minh Ralph Eastwood (Ported to VexCL and minimalised)
...
void StreamCountKernel( __global u32* gSrc, __global u32* histogramOut, int4 cb )
{
	...
	{
		u32 sum = 0;
		for(size_t i=0; i<GET_GROUP_SIZE; i++)
		{
